...
namespace ProjectCustomer
{
    class Program
    {
        ...
        static void TambahCustomer()
        {
            ...
            customer.TotalPiutang = double.Parse(Console.ReadLine());
        ...
        static void TampilCustomer()
        {
            ...
            {
                noUrut++;
                Console.WriteLine("{0}. Kode Customer: {1}, Nama Customer: {2}, Total Piutang: {3}", noUrut, produk.KodeProduk, produk.NamaProduk, produk.HargaBeli, produk.HargaJual);
            }
            if (noUrut < 1)
            {
